    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a3 = element("a");
    			img5 = element("img");
    			attr_dev(img0, "class", "background-image svelte-fep4uh");
    			if (img0.src !== (img0_src_value = "/assets/cover.jpg")) attr_dev(img0, "src", img0_src_value);
    			add_location(img0, file, 5, 4, 93);
    			attr_dev(img1, "class", "album svelte-fep4uh");
    			if (img1.src !== (img1_src_value = "/assets/cover.jpg")) attr_dev(img1, "src", img1_src_value);
    			add_location(img1, file, 7, 8, 181);
    			attr_dev(h1, "class", "title svelte-fep4uh");
    			add_location(h1, file, 9, 12, 276);
    			attr_dev(span, "class", "message svelte-fep4uh");
    			add_location(span, file, 10, 12, 320);
    			attr_dev(div0, "class", "text-container svelte-fep4uh");
    			add_location(div0, file, 8, 8, 235);
    			attr_dev(div1, "class", "info svelte-fep4uh");
    			add_location(div1, file, 6, 4, 154);
    			if (img2.src !== (img2_src_value = "/assets/spotify.png")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "Spotify");
    			attr_dev(img2, "class", "svelte-fep4uh");
    			add_location(img2, file, 15, 12, 523);
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "href", "https://open.spotify.com/artist/6TSLU6RCFiLnRKXCBn0Sbo");
    			attr_dev(a0, "class", "svelte-fep4uh");
    			add_location(a0, file, 14, 8, 429);
    			if (img3.src !== (img3_src_value = "/assets/youtube.png")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "Youtube");
    			attr_dev(img3, "class", "svelte-fep4uh");
    			add_location(img3, file, 22, 12, 749);
    			attr_dev(a1, "class", "youtube svelte-fep4uh");
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "href", "https://www.youtube.com/channel/UCb854cgygVAg8MnBxIoYqcA");
    			add_location(a1, file, 17, 8, 592);
    			if (img4.src !== (img4_src_value = "/assets/apple.png")) attr_dev(img4, "src", img4_src_value);
    			attr_dev(img4, "alt", "Apple Music");
    			attr_dev(img4, "class", "svelte-fep4uh");
    			add_location(img4, file, 25, 12, 914);
    			attr_dev(a2, "target", "_blank");
    			attr_dev(a2, "href", "https://music.apple.com/us/artist/sly-disciple/958399218");
    			attr_dev(a2, "class", "svelte-fep4uh");
    			add_location(a2, file, 24, 8, 818);
    			if (img5.src !== (img5_src_value = "/assets/ig.png")) attr_dev(img5, "src", img5_src_value);
    			attr_dev(img5, "alt", "Instagram");
    			attr_dev(img5, "class", "svelte-fep4uh");
    			add_location(img5, file, 28, 12, 1064);
    			attr_dev(a3, "target", "_blank");
    			attr_dev(a3, "href", "https://www.instagram.com/sly.disciple/");
    			attr_dev(a3, "class", "svelte-fep4uh");
    			add_location(a3, file, 27, 8, 985);
    			attr_dev(div2, "class", "footer svelte-fep4uh");
    			add_location(div2, file, 13, 4, 400);
    			attr_dev(main, "class", "hero svelte-fep4uh");
